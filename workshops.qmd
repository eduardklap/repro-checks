...
Together with the [eScience Center](https://www.esciencecenter.nl/){target="_blank"}, we also hosted a successful hackathon-style workshop at ESSB about ***Reproducible research through reusable code***. 

We welcomed 16 participants, who worked on publishing and improving their own project in a day. At the end of the day, they had their code published on GitHub, with a README included, with explicitly documented software dependencies, and more improvements that made their code more reproducible and reusable. But most of all, we had fruitful exchanges about how to work more reproducible, and everyone went home with more tools in their toolbox to do so.   

The course materials are available at the [workshop website](https://esciencecenter-digital-skills.github.io/reproducible-research-through-reusable-code/){target="_blank"}: in case you are interested you can complete all the exercises yourself! 

We are planning **another edition of the workshop** in early 2025, stay tuned for the announcement!
...
![Reproducible research through reusable code workshop flyer](fig/flyer_reproducible-research-workshop.jpg){width=550}
