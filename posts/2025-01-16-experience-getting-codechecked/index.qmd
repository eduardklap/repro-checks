...
![Image: The [CODECHECK](https://codecheck.org.uk/process/#figure-2-the-codecheck-example-process-implementation){target="_blank"} example workflow implementation.](codecheck_overview.svg){width="550"}
