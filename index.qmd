...
1.  Let me know you are interested and provide some background about your paper or project (via email or via the [form](submit.qmd)).
...
The project is supported by [Sven van den Burg](https://www.esciencecenter.nl/team/sven-van-der-burg/){target="_blank"}, Research Software Engineer at the eScience Center.

::: {layout-ncol="2"}
[![Netherlands eScience Center](fig/netherlands-escience-center-logo-RGB-768x211.png){width="207" height="56"}](https://www.esciencecenter.nl/){target="_blank"}

[![Erasmus School of Social and Behavioural Sciences](fig/EUR_ESSB_EN%20stack_01_RGB_2400_colour.png){width="176"}](https://www.eur.nl/essb){target="_blank"}
:::
